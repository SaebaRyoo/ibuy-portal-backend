export const RabbitMQConstants = {
  ...
  /*** 普通订单相关队列和交换机 ***/
  QUEUE_ORDER_DELAY: 'queue.order.delay', // 普通订单 死信队列
  QUEUE_ORDER_CHECK: 'queue.order.check', // 普通订单 订单延时消费队列
  ...
  /*** 秒杀订单相关队列和交换机 ***/
  QUEUE_SEC_KILL_ORDER_DELAY: 'queue.seckill.delay', // 秒杀订单 死信队列
  QUEUE_SEC_KILL_ORDER_CHECK: 'queue.seckill.order.check', // 秒杀订单 订单延时消费队列
